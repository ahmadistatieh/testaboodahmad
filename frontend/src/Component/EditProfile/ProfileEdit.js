    ...
    return (
        ...
        <div>
                    ...
                    <div className="d-sm-flex align-items-start text-center text-sm-start">
                        ...
                        <div className="ms-sm-4 mt-sm-3" style={{ width: "200px" }}>
                            <h1 className="ProfileName mb-0 h4">
                                User Name  <i className="bi bi-patch-check-fill text-success small" />
                            </h1>
                        </div>
                    </div>
                </div>
            ...
            <div className="form-group field">
                <input type="text" className="form-field-2 " placeholder="edit your bio..." name="name" id="name" required />
            </div>
            <div className="form-group field">
                <input type="text" className="form-field-2 " placeholder="edit your name..." name="name" id="name" required />
            </div>
            <div className="butEdit">
                <div className="flex-grid-center" style={{ marginRight: "600px" }}>
                    <button className="pure-button fuller-button blue" onClick={handleshowprofile}>save</button>
                    <button className="pure-button fuller-button red" onClick={handleshowprofile}>cancel</button>
                </div>
            </div>
        </div>
    )
